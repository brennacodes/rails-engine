module Typable
  def find_type
    return "name" if params[:name]
    return "description" if params[:description]
    return "merchant_id" if params[:merchant_id]
    return "unit_price_max" if params[:unit_price_max]
    return "unit_price_min" if params[:unit_price_min]
    return "unit_price" if params[:unit_price]
    return "error"
  end
